...
"""
Acrobot Modell auf Basis der kollokierten partiellen Linearisierung

-> hat sich als unzweckmäßig herausgestellt
"""
...
params = sp.symbols('l1, l2, s1, s2, J1, J2, m1, m2, g')
st.make_global(params, 1)




F_eq = sp.Matrix([[x3 - xdot1], [x4 - xdot2], [-xdot3 - xdot4*(J2 + l1*m2*s2*cos(x2) + m2*s2**2)/(J1 + J2 + l1**2*m2 + 2*l1*m2*s2*cos(x2) + m1*s1**2 + m2*s2**2) - (g*l1*m2*sin(x1) + g*m1*s1*sin(x1) + g*m2*s2*sin(x1 + x2) - 2*l1*m2*s2*x3*x4*sin(x2) - l1*m2*s2*x4**2*sin(x2))/(J1 + J2 + l1**2*m2 + 2*l1*m2*s2*cos(x2) + m1*s1**2 + m2*s2**2)]])
